...
def _chw_to_gl_rgba(tensor: torch.Tensor) -> torch.Tensor:
...
def _hwc_to_gl_rgba(tensor: torch.Tensor) -> torch.Tensor:
...
def _gradient_to_gl(gradient: torch.Tensor) -> torch.Tensor:
